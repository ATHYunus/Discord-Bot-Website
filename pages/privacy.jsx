export default function Privacy() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-3xl text-white/75">Privacy Policy for ATH Bot</h1>
  ...
  <div className="animateHeader text-white text-opacity-40 mt-5">
        <p>⊳ To use the ATH bot, you must define the necessary permissions when adding it to your discord server. <a className="text-white">(READ MESSAGES, SEND MESSAGES, EMBED LINKS, ATTACH FILES, READ MESSAGE HISTORY, CONNECT, SPEAK, USE VOICE ACTIVITY, PRIORITY SPEAKER)</a></p>
